...
public class LibraryService {
    ...
    public Page<LibraryEntryResponse> getUserLibrary(
            UUID userId, LibraryStatus status, OwnershipStatus ownership, String platform, Pageable pageable) {
    ...
    public Page<LibraryEntryResponse> getUserLibraryForViewer(
            String username, UUID currentUserId,
            LibraryStatus status, OwnershipStatus ownership, String platform, Pageable pageable) {
    ...
    public LibraryEntryResponse updateEntry(UUID entryId, UUID requestingUserId, UpdateLibraryEntryRequest request) {
