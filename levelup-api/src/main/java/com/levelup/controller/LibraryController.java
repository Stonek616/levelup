...
public class LibraryController {
  ...
  public ResponseEntity<Page<LibraryEntryResponse>> getLibrary(
      ...
      Pageable pageable) {
    Page<LibraryEntryResponse> entries =
        libraryService.getUserLibrary(userDetails.getId(), status, ownership, platform, pageable);
  ...
  public ResponseEntity<Void> deleteEntry(
      @AuthenticationPrincipal UserDetailsImpl userDetails, @PathVariable UUID entryId) {
  ...
  public ResponseEntity<LibraryEntryResponse> getEntryByGame(
      @AuthenticationPrincipal UserDetailsImpl userDetails, @PathVariable UUID gameId) {
