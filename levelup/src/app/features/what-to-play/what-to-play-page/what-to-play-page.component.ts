  ...
  readonly platformGroups: {
    ...
    },
    {
      ...
      options: [
        ...
        {
          value: 'SUPER_NINTENDO_ENTERTAINMENT_SYSTEM',
          label: 'Super Nintendo (SNES)',
        },
        {
          value: 'NINTENDO_ENTERTAINMENT_SYSTEM',
        ...
        {
          value: 'FAMILY_COMPUTER_DISK_SYSTEM',
    ...
    },
    {
      ...
      options: [
        ...
        {
          value: 'SEGA_MASTER_SYSTEM_MARK_III',
          label: 'Master System / Mark III',
        },
    ...
    },
    {
      ...
      options: [
        {
          value: 'THREE_DO_INTERACTIVE_MULTIPLAYER',
        ...
        {
          value: 'LEAPSTER_EXPLORER_LEADPAD_EXPLORER',
          label: 'Leapster / LeadPad Explorer',
        },
        ...
        {
          value: 'TURBOGRAFX_16_PC_ENGINE',
          label: 'TurboGrafx-16 / PC Engine',
        },
        {
          value: 'TURBOGRAFX_16_PC_ENGINE_CD',
          label: 'TurboGrafx-16 / PC Engine CD',
        },
    ...
    return (
      {
        ...
        NEW_SUGGESTION: 'New',
      } as Record<SuggestionSource, string>
    )[source];
  }
}
