...
public class IgdbClient {
    ...
    /**
     * Executes an Apicalypse query against the given IGDB endpoint and 
     * deserializes the response into a list of the given type.
     *
     ...
     */
    public <T> List<T> query(String endpoint, String query, ParameterizedTypeReference<List<T>> type) {
