...
public class UserService {
  ...
  public UserResponse getByUsername(String username, UUID currentUserId) {
    ...
    long libraryCompleteTotalCount =
        libraryEntryRepository.countByUserIdAndStatus(user.getId(), LibraryStatus.COMPLETED);
    ...
    if (currentUserId == null || currentUserId.equals(user.getId())) {
      return UserResponse.from(
          user, libraryTotalCount, libraryCompleteTotalCount, reviewCount, friendCount);
    }
    boolean isFriend = friendService.areUsersFriends(currentUserId, user.getId());
    String requestStatus =
        isFriend ? null : friendService.getRequestStatus(currentUserId, user.getId());
    return UserResponse.from(
        user,
        libraryTotalCount,
        libraryCompleteTotalCount,
        reviewCount,
        friendCount,
        isFriend,
        requestStatus);
  ...
  public Page<UserSummaryResponse> searchUsers(
      String query, UUID currentUserId, Pageable pageable) {
