...
public class IgdbTokenService {
     ...
     * Refreshes 5 minutes before actual expiry to avoid edge-case 401s.
     */
    ...
    private void refreshToken() {
        ...
        TwitchTokenResponse response = tokenClient.post()
                .uri(url)
    ...
    /**
     * The shape Twitch returns for a client_credentials token request.
     * @JsonProperty maps the snake_case JSON fields to our camelCase record components.
     */
