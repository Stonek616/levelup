...
public class AccountPurgeScheduler {
    ...
    public void purgeExpiredAccounts() {
        ...
        List<UUID> ids = userRepository.findSoftDeletedBefore(cutoff).stream()
                .map(u -> u.getId())
                .toList();
        ...
        log.info("Purged {} soft-deleted account(s) past the {} day grace period", ids.size(), GRACE_PERIOD_DAYS);
    }
}
