...
public class UserController {
  ...
  public ResponseEntity<Void> removeGameProfile(
      @AuthenticationPrincipal UserDetailsImpl userDetails, @PathVariable UUID profileId) {
  ...
  public ResponseEntity<Page<LibraryEntryResponse>> getUserLibrary(
    ...
    return ResponseEntity.ok(
        libraryService.getUserLibraryForViewer(
            username, currentUserId, status, ownership, platform, pageable));
  }
  ...
  public ResponseEntity<TasteProfileResponse> getTasteProfile(@PathVariable String username) {
  ...
  public ResponseEntity<Page<FeedEventResponse>> getUserActivity(
      @PathVariable String username, @PageableDefault(size = 10) Pageable pageable) {
